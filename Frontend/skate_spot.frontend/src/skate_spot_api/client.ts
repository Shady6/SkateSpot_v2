...
export class Client {
  ...
  protected processGet_Spot_And_Spot_Video_Stats(
    response: Response
  ): Promise<SpotAndSpotVideoStatsApiResponse> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
    ...
    if (status === 200) {
      return response.text().then(_responseText => {
        ...
        result200 =
          _responseText === ''
            ? null
            : <SpotAndSpotVideoStatsApiResponse>(
                JSON.parse(_responseText, this.jsonParseReviver)
              )
        return result200
      })
  ...
  get_Temp_Spots(
    ...
    filtering_SurfaceFilter_Score: number | undefined,
    filtering_ObstaclesFilter_Obstacles: ObstacleType[] | undefined
  ): Promise<TempSpotDtoWithTotalCountApiResponse> {
    let url_ = this.baseUrl + '/api/TempSpots?'
    if (take === null) throw new Error("The parameter 'take' cannot be null.")
    else if (take !== undefined)
      url_ += 'take=' + encodeURIComponent('' + take) + '&'
    ...
    if (status === 200) {
      return response.text().then(_responseText => {
        ...
        result200 =
          _responseText === ''
            ? null
            : <TempSpotDtoWithTotalCountApiResponse>(
                JSON.parse(_responseText, this.jsonParseReviver)
              )
        return result200
      })
  ...
  protected processGet_Temp_Spot(
    response: Response
  ): Promise<TempSpotDtoApiResponse> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processGet_User_Stats(
    response: Response
  ...
  get_User_Related_Spots(
    ...
    url_ = url_.replace(
      '{interactionType}',
      encodeURIComponent('' + interactionType)
    )
    if (take === null) throw new Error("The parameter 'take' cannot be null.")
    else if (take !== undefined)
      url_ += 'take=' + encodeURIComponent('' + take) + '&'
  ...
  protected processGet_User_Related_Spots(
    response: Response
  ): Promise<SpotDtoWithTotalCountApiResponse> {
    const status = response.status
    let _headers: any = {}
  ...
  protected processGet_User_Related_Spot_Videos(
    response: Response
  ): Promise<SpotVideoDtoWithTotalCountApiResponse> {
    const status = response.status
    let _headers: any = {}
